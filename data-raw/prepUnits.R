...
StoxUnits <- data.table::data.table(
	id = character(),
	quantity = character(),
	symbol = character(),
	shortname = character(),
...
StoxUnits <- rbind(StoxUnits, list("area_number_density-TN/nmi^2", "area_number_density", "TN/nmi^2", "10^12 individuals/nmi^2", "trillion individuals per square nautical mile", 1e12))

StoxUnits <- rbind(StoxUnits, list("area_weight_density-mcg/nmi^2", "area_weight_density", "mcg/nmi^2", "mcg/nmi^2", "microgram per square nautical mile",      1e-9))
StoxUnits <- rbind(StoxUnits, list("area_weight_density-mg/nmi^2",  "area_weight_density", "mg/nmi^2",  "mg/nmi^2",  "milligram per square nautical mile",      1e-6))
StoxUnits <- rbind(StoxUnits, list("area_weight_density-g/nmi^2",   "area_weight_density", "g/nmi^2",   "g/nmi^2",   "gram per square nautical mile",           1e-3))
StoxUnits <- rbind(StoxUnits, list("area_weight_density-kg/nmi^2",  "area_weight_density", "kg/nmi^2",  "kg/nmi^2",  "kilogram per square nautical mile",       1))
StoxUnits <- rbind(StoxUnits, list("area_weight_density-ton/nmi^2", "area_weight_density", "ton/nmi^2", "ton/nmi^2", "metric ton per square nautical mile",     1e3))
StoxUnits <- rbind(StoxUnits, list("area_weight_density-kt/nmi^2",  "area_weight_density", "kt/nmi^2",  "kt/nmi^2",  "metric kiloton per square nautical mile", 1e6))
StoxUnits <- rbind(StoxUnits, list("area_weight_density-Mt/nmi^2",  "area_weight_density", "Mt/nmi^2",  "Mt/nmi^2",  "metric megaton per square nautical mile", 1e9))
