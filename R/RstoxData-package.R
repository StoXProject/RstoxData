...
utils::globalVariables(c(
	 ".", "..Country", "..NAToInsert", "..Organisation", "..SurveyName", "..allDuplicated",
	 "..colList", "..columns", "..digits", "..groupingVariables", "..keep", "..key",
	 "..parameterNames", "..relevantColumns", "..replacement", "..signifDigits", "..sourceColumns",
	 ...
	 "EDSU", "EchoType", "EffectiveTowDistance", "FishID", "Gear", "GearEx", "HaulNo", "HaulVal",
	 "LengthCode", "LocalID", "LogKey", "N", "NewValue", "NumberAtLength",
	 ...
	 "TransducerOrientation", "VariableName", "WeightMeasurement", "age", "agingstructure", "ap",
	 "aphia", "area", "as.formula", "bottomdepthstart", "bottomdepthstop", "catCatchWgt",
	 ...
	 "isCrustacean", "isHerringOrSprat", "isPelagic", "iskey", "latitudeend", "latitudestart",
	 "lenInterval", "lengthCode", "lengthmeasurement", "lengthresolution", "lengthsamplecount",
	 "lengthsampleweight", "level", "lngtClass", "lngtCode", "location", "logstart", "longitudeend",
	 "longitudestart", "lsCountTot", "lsc", "maturationstage", "maturity", "maxFishID", "meanW",
	 "missionstartdate", "missionstopdate", "ms", "nInd", "nWithWeight", "nation", "newClass",
	 "noMeas", "parasite", "platformname", "preferredagereading", "readability", "reportInMM",
	 "reportingUnit", "res", "rowIndex", "s", "sa", "sum_sa.x", "sum_sa.y", "sampleFac",
	 "samplequality", "sampletype", "serialnumber", "sex", "shortname", "sp", "specialstage",
	 ...
	 "suffixes", "sweeplength", "target", "tissuesample", "totWeight", "totalNo", "transceiver",
