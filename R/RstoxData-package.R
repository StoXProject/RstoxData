...
utils::globalVariables(c(
	 ...
	 "FishID", "Frequency", "Gear", "GearEx", "HLNoAtLngt", "HaulNo", "ID", "LocalID", "LogKey",
	 "N", "NewValue", "NumberAtLength", "NumberOfIndividualsToGenerate",
	 ...
	 "Value", "VariableName", "WeightMeasurement", "acocat", "age", "agingstructure", "aphia",
