...
utils::globalVariables(c(
	 ...
	 "..digits", "..groupingVariables", "..keep", "..parameterNames", "..relevantColumns",
	 ...
	 "FishID", "Frequency", "Gear", "GearEx", "HLNoAtLngt", "HaulNo", "InstrumentID", "LocalID",
	 "LogKey", "N", "NewValue", "NumberAtLength", "NumberOfIndividualsToGenerate",
	 "NumberOfSampledIndividuals", "Quarter", "ReplaceBy", "SaCategory", "Scaling", "Ship",
	 "SpecVal", "SpeciesCategoryNumber", "SpeciesCategoryWeight", "SpeciesCode", "StatRec",
	 "SubsampleWeight", "SubsampledNumber", "Survey", "SweepLngt", "Time", "TransducerOrientation",
	 "VariableName", "WeightMeasurement", "acocat", "age", "agingstructure", "aphia", "area",
	 "as.formula", "bottomdepthstart", "bottomdepthstop", "catCatchWgt", "catchcount",
	 "catchpartnumber", "catchproducttype", "catchweight", "ch", "cruise", "direction", "distance",
	 "fishingdepthcount", "fishingdepthmax", "fishingdepthmin", "freq", "gear", "gearflow",
	 "inapplicableFormats", "individualweight", "integrator_dist", "iskey", "lat_start", "lat_stop",
	 "latitudeend", "latitudestart", "lengthCode", "lengthmeasurement", "lengthresolution",
	 "lengthsamplecount", "lengthsampleweight", "level", "liverweight", "lngtClass", "lngtCode",
	 "location", "log_start", "logstart", "lon_start", "lon_stop", "longitudeend", "longitudestart",
	 "lsCountTot", "maturity", "maxFishID", "max_bot_depth", "meanW", "missionstartdate",
	 "missionstopdate", "nInd", "nWithWeight", "nation", "newClass", "noMeas", "parasite",
	 "pel_ch_thickness", "platform", "platformname", "preferredagereading", "readability",
	 ...
	 "suffixes", "sum_sa.x", "sum_sa.y", "sweeplength", "target", "threshold", "tissuesample",
	 "totWeight", "totalNo", "transceiver", "translationListOne", "trawldoorarea",
